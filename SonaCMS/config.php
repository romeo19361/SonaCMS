<?php
// SonaCMS-V1.1/config.php

return [
    'licensed' => false, //true or false (purchase the relevant license at www.sonacms.com)
    'licensee_name' => 'Your business name', // Name shown in the licensed footer
